...
const BaiTapRenderXe = () => {
  ...
  // Tạo 1 state để quản lí thông tin chi tiết  xe
  const [xeDetail, setXeDetail] = useState(); //dữ liệu mặc định | undefine
  ...
  let arrListXe = [
    ...
    {
      id: 2,
      img: "./imgCar/red-car.jpg",
      name: "red car",
      price: 2000,
    },
    {
      id: 3,
      img: "./imgCar/silver-car.jpg",
      name: "silver car",
      price: 3000,
    },
    {
      id: 4,
      img: "./imgCar/steel-car.jpg",
      name: "steel car",
      price: 4000,
    },
  ];
